...
async def next_page(bot, query):
    ...
    btn.insert(0,
            [
                InlineKeyboardButton("⭕️ 𝚄𝙿𝙳𝙰𝚃𝙴 ⭕️", url="https://t.me/MovieFactory_Official"),
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
                    ...
                    reply_markup=InlineKeyboardMarkup(
                      [
                       [
                        ...
                        InlineKeyboardButton("💥 𝚃𝚑𝚊𝚗𝚔𝚜 💥", url="https://t.me/share/url?url=/𝚏𝚘𝚗𝚝 𝚃𝚑𝚊𝚗𝚔𝚜")
                     ],[
        ...
        buttons= [[
            ...
            InlineKeyboardButton('🍿ᴍᴏᴠɪᴇ ʀᴇǫᴜᴇsᴛ ɢʀᴏᴜᴘ🍿', url='https://t.me/MovieFactory_Official')
            ],[
